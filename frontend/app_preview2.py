...
def render_features():
    features = [
        ...
        ("🛡️", "Privacy First", "Local processing ensures your candidate data never leaves your infrastructure.")
    ]
...
def display_analysis_results(result: Dict):
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["📊 Overview", "🔧 Skills", "📝 Explanation", "📋 Data"])
    ...
    with tab2:
        ...
        with col1:
            ...
            if result['skill_comparison']['matched_skills']:
                ...
                st.info("No matched skills found", icon="️⚠")
...
def main():
    ...
    <div style="text-align: center; padding: 4rem 2rem; border-top: 1px solid rgba(255,255,255,0.1); margin-top: 4rem;">
        <p style="color: rgba(255,255,255,0.4); font-size: 0.875rem;">
            AI Resume Matcher • Built with Streamlit & Transformers
        </p>
    </div>
    """, unsafe_allow_html=True)
